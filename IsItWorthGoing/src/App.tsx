...
function App() {
  ...
  return (
    ...
    <div id="pleaseSTOP" className='grid grid-cols-1 grid-rows-3 sm:grid-rows-3 sm:grid-cols-1 gap-2 place-items-center'>
       <h1 className='font-inter text-white text-4xl sm:text-5xl md:text-[4.5rem] mt-64 md:mt-[50%] lg:mt-64 animate__animated animate__fadeInUp'>Is It Worth Going To?</h1>
       <Search></Search>
    </div>
    </div>
  )
